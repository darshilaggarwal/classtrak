...
const TeacherSignupPage = () => {
  ...
  const validateStep1 = () => {
    ...
    } else if (!formData.email.toLowerCase().endsWith('@imaginxp.com')) {
      newErrors.email = 'Please use your official @imaginxp.com email address';
    }
  ...
  const handleStep1Submit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setCurrentStep(2);
        setStatusMessage('');
        toast.success('OTP sent to your @imaginxp.com email!');
  ...
  const handleStep2Submit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        console.log('✅ Teacher account setup completed for:', response.data.user.name);
      ...
      <div className="max-w-sm sm:max-w-md w-full space-y-6 md:space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm md:text-base text-neutral-600">
            {currentStep === 1 
              ? 'Enter your @imaginxp.com email to get started'
          ...
          <div className="card p-4 md:p-6 lg:p-8">
            <form className="space-y-6" onSubmit={handleStep1Submit}>
              <Input
                ...
                placeholder="your.name@imaginxp.com"
                icon={Mail}
                error={errors.email}
                helper="We'll send an OTP to your @imaginxp.com email address"
                required
              />
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm text-green-700 font-medium">
                    OTP sent to your @imaginxp.com email!
                  </p>
